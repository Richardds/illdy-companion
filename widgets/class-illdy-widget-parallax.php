...
class Illdy_Widget_Parallax extends WP_Widget{
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'illdy-companion-epsilon-object', ILLDY_COMPANION_ASSETS_DIR . '/js/epsilon.js', [ 'jquery' ] );
	}
	...
	function form( $instance ) {
        ...
        <p class="illdy-media-control" data-delegate-container="<?php echo esc_attr( $this->get_field_id( 'image_src' ) ) ?>">
            <label for="<?php echo esc_attr( $this->get_field_id( 'image_src' ) ); ?>"><?php _e( 'Image', 'illdy-companion' );
				?>:</label>
