...
class Illdy_Companion_Import_Data{
	function __construct() {
		 ...
		 */
		add_filter( 'illdy_required_actions', [ $this, 'generate_import_data_container' ] );
	}

	public static function process_sample_content( $args = [] ) {
	...
	public static function import_customizer() {
		...
		$illdy_customizer_defaults = [
			...
			'_sponsors_general_show'                     => 1,
			'_sponsors_general_title'                    => __( 'Sponsors', 'illdy-companion' ),
			'_sponsors_general_entry'                    => __( 'It is an amazing one-page theme with great features that offers an incredible experience. It is easy to install, make changes, adapt for your business. A modern design with clean lines and styling for a wide variety of content, exactly how a business design should be. You can add as many images as you want to the main header area and turn them into slider.', 'illdy-companion' ),
